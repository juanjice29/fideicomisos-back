    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numeroEncargo",
                    models.CharField(db_column="numero_encargo", max_length=50),
                ),
                (
                    "fideicomiso",
                    models.CharField(db_column="fideicomiso", max_length=50),
                ),
                (
                    "descripcion",
                    models.CharField(db_column="descripcion", max_length=300),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "descripcion",
                    models.CharField(
                        db_column="descripcion", max_length=300, null=True
                    ),
                ),
                (
                    "fideicomiso",
